...
function OpenAccount() {
  ...
  const validateStep = (step) => {
    ...
    switch (step) {
      case 1:
        ...
        else if (!/^[A-Z]{5}[0-9]{4}[A-Z]{1}$/i.test(formData.panNumber.trim())) errors.panNumber = 'Invalid PAN format';
        break;
      case 2:
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/api/submit-account', {
        method: 'POST',
        body: formDataToSend,
      });
        ...
        <div className="success-popup-overlay">
          <div className="success-popup">
            <div className="success-animation">
              ...
              <span className="success-message">Details submitted successfully!</span>
            </div>
          </div>
        </div>
      )}
                  ...
                  <div className="terms-section">
                    <div className="terms-container">
                      ...
                      <div className="terms-content">
                        <p className="terms-intro">✅ I agree to the Terms and Conditions</p>
                        <p className="terms-text">By checking this box, I confirm that:</p>
                        <ul className="terms-list">
                          <li>I authorize BankEase to securely collect, store, and transmit my personal and financial details to the selected Partner Bank(s) for the purpose of account opening or verification.</li>
                          <li>I understand that BankEase is a facilitator and not a bank. Final decisions rest with the respective bank(s).</li>
                          <li>I acknowledge that all data submitted is true and correct to the best of my knowledge.</li>
                          <li>I understand that my documents may be used for KYC (Know Your Customer) and identity verification as per regulatory norms.</li>
                          <li>I consent to the use and processing of my data in accordance with the BankEase Privacy Policy and applicable Indian data protection laws.</li>
                          <li>I am aware that any false or misleading information may result in application rejection or legal action.</li>
                        </ul>
                        <p className="terms-security">🔒 Your data is encrypted and handled with the highest security standards.</p>
                      </div>
                      <div className="terms-checkbox">
                        <label className="checkbox-label">
                          ...
                          />
                          <span className="checkbox-text">I accept the terms and conditions</span>
                        </label>
